    ...
    <section>
        <div class="container">
            ...
            <div class="atualizacao">
                <div class="atualizacao-individual">
                    <p class="titulo negrito">Noticia tal</p>
                    ...
                    <a data-modal-target="#atualizacao-individual-2"><button class='vejamais atualizacao-botao'>Leia mais</button></a>
                </div>
                <div class="atualizacao-individual">
                        <p class="titulo negrito">Noticia tal</p>
                        <p>No meu xinélo da humildade eu gostaria muito de ver o Neymar e o Ganso. Por que eu acho que.... 11 entre 10 brasileiros gostariam. Você veja, eu já vi, parei de ver. Voltei a ver, e acho que o Neymar e o Ganso têm essa capacidade de fazer a gente olhar.</p>
                        <a data-modal-target="#atualizacao-individual-1"><button class='vejamais atualizacao-botao'>Leia mais</button></a>
                </div>
            </div>
            <div class="atualizacao">
                <div class="atualizacao-individual">
        ...
        <div class="modal modal-maior" id="atualizacao-individual-1">
                <div class="modal-header">
                  <div class="titulo negrito">Atualização Modelo 1</div>
        ...
        <div class="modal modal-maior" id="atualizacao-individual-2">
                    <div class="modal-header">
                      <div class="titulo negrito">Atualização Modelo 2</div>
                      <button data-close-button class="close-button">&times;</button>
                    </div>
                    <div class="modal-body">
